        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute bottom-5 sm:bottom-[106px] right-4 sm:right-6 z-50 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-bold text-sm sm:text-base px-5 py-2.5 sm:px-6 sm:py-3 rounded-full shadow-lg transition whitespace-nowrap opacity-90 hover:opacity-100"
            >
              🚀 Empezar gratis →
            </button>
